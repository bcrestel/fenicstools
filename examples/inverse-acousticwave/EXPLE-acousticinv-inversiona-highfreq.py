...
from parametersinversion import parametersinversionhighfreq

# parameters
a_target_fn, a_initial_fn, b_target_fn, b_initial_fn, wavepde, obsop = parametersinversionhighfreq()
Vm = wavepde.Vm
V = wavepde.V
